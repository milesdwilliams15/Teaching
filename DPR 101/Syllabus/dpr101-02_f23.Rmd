...
> [DPR 101 Lecture Notes.](https://github.com/milesdwilliams15/Teaching/blob/main/DPR%20101/Notes/README.md)

# Resources

## We Have two TAs!

Brennan Kelley and Joanna Passalaris are the Teaching Assistants for DPR 101. If you have questions about assignments or need help troubleshooting code, Brennan and Joanna are excellent resources.

**Office Hours**: TBD

**Location**: TBD

**Contact**: [kelley_b1@denison.edu](mailto:kelley_b1@denison.edu){.email}; [passal_j1@denison.edu](mailto:passal_j1@denison.edu){.email}
