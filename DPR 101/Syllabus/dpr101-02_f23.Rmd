...
ma_dates <- c(ymd(20231006), 
              ymd(20231027),
              ymd(20231110),
              ymd(20231217)) 
  # Final date set to Thursday, Dec. 14, 2:00-4:00 p.m. for section 01
  # Final date set to Sunday, Dec. 17, 2:00-4:00 p.m. for section 02
# graph challenges:
gc_dates <- c(ymd(20230906),
              ymd(20230913),
              ymd(20230920),
              ymd(20230927),
              ymd(20231011),
...
ggsave(
  here::here('DPR 101','schedule-02.png'),
  height = 6,
  width = 8
)
```
...
*Note:* When "Discussion" is listed for a given day, the assigned readings are on Canvas. Unless otherwise indicated, due dates are by midnight. "H" = the Healy textbook. "DC" = Data Challenge (due Wednesdays). "MA" = Main Assignment (due Fridays).
...
- Day 3: NO CLASS (APSA conference)
...
- Day 2: H Ch2 (2.5 - 2.7)  \hfill \textit{DC0 due Wed.}
...
- Day 2: H Ch3 (3.5 - 3.8) \hfill \textit{DC1 due Wed.}
...
- Day 2: H Ch4 (4.1 - 4.4) \hfill \textit{DC2 due Wed.}

- Day 3: H Ch4 (4.5 - 4.8)

## `r advdate(mon, 5)`: Draw Maps

- Day 1: H Ch7 (7.1 - 7.3) 

- Day 2: H Ch7 (7.4 - 7.6) \hfill \textit{DC3 due Wed.}

- Day 3: Discussion 

## `r advdate(mon, 6)`: Finalize MA1

- Day 1: Work on MA1 

- Day 2: Work on MA1 

- Day 3: Work on MA1 \hfill \textit{MA1 due Fri.}
...
- Day 2: H Ch5 (5.1 - 5.3) \hfill \textit{DC4 due Wed.}
...
- Day 2: H Ch8 (8.3 - 8.4) \hfill \textit{DC5 due Wed.}

- Day 3: Discussion 


## `r advdate(mon, 9)`: More Refining and Finalize MA2
...
## `r advdate(mon, 10)`: Dealing with Survey Data

- Day 1: Survey data 

- Day 2: Using a code book \hfill \textit{DC6 due Wed.}

- Day 3: Discussion 

## `r advdate(mon, 11)`: Finalize MA3

- Day 1: Work on MA3 

- Day 2: Work on MA3 

- Day 3: Work on MA3 \hfill \textit{MA3 due Fri.}

# Part IV: Choose-your-own-adventure

## `r advdate(mon, 12)`: Your Adventure Starts!

- Day 1: Start Choose-your-own-adventure 

- Day 2: Pitch your research \hfill \textit{DC7 due Wed.}

- Day 3: NO CLASS (ISA-Midwest Conference)
...
- Day 2: Work on MA4 \hfill \textit{DC8 due Wed.}
...
- Day 1: Course evals \hfill \textit{MA4 due 12.17 by 4:00 pm}
...
[X] is the Teaching Assistant for DPR 101. If you have questions about assignments or need help troubleshooting code, Will is an excellent resource.

**Office Hours**: Tues. 11:00 am - 12:30 pm / Thurs. 5:00 pm - 6:00 pm
...
\underline{+ \space 8 \times 3\% = 24\%} &  \text{ (Data Challenges)} \\
