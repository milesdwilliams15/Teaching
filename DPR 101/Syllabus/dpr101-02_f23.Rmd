...
*Note:* When "Discussion" is listed for a given day, the assigned readings are on Canvas. Unless otherwise indicated, due dates are by midnight. "H" = the Healy textbook. "DC" = Graph Challenge (due Wednesdays). "MA" = Main Assignment (due Fridays).
