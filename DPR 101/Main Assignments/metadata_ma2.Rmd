---
title: "Metadata for the conflict time-series dataset"
...
The data used to create the dataset for Main Assignemnt 2 was accessed and compiled using the `{peacesciencer}` R package. The script necessary to recreate the dataset is included below:
...
The output of the above is an object called `sm_data` which is a conflict dataset of international wars fought between 1816 to 2007. The unit of observation is a given war.
