...
That's better, but we don't have a finished product yet. Another option to try is to add a couple of different smoothed layers. One where we map groups to states and another that just shows the overall trend. We'll drop the points geom, too.
