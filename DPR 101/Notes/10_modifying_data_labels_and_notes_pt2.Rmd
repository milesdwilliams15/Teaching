...
We can clearly see from the above that each of the measures are correlated over time. However, V-Dem's polyarchy scale is much less optimistic than the others.
