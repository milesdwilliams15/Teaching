...
In fact, when writing a report, using many kinds of visualization can be a helpful way to show an audience data from multiple angles.
...
file_location <- here::here("DPR 101", "Data", "538_prez_forecast_error_20162020.csv")
