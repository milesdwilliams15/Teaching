...
In sum, surveys of random samples from a population, while still subject to error, are one of the best social science tools we have for making population inferences. However, even with a random sample, we still have to consider the second kind of bias: **social desirability**.
