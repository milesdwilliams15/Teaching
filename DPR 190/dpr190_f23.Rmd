...
\item Day 3: In-class group work on TD1.
...
##  `r advdate(mon, 7)`: The Undead and Realism 
...
\item Day 1: In-class TD1 presentations.

\item Day 2: Drezner, "Introduction...to the Undead," "The Zombie Literature," "Defining a Zombie," and "Distracting Debates about Flesh-eating Ghouls." Listen to: Hopkins Podcast on Foreign Affairs, \href{https://hopkinspofa.com/2018/01/20/ir-theory-aliens/}{"IR Theory and Aliens!"}

\item Day 3: Drezner, "The Realpolitik of the Living Dead".
...
##  `r advdate(mon, 8)`: Liberalism and Constructivism
...
\item Day 2: Drezner, "Subalternity and the Living Dead: Postcolonial Approaches to a Posthuman World."

\item Day 3: Drezner, "A Very Important Note about Zombie Networks."
...
\item Day 1: Work day for TD3

\item Day 2: Paul Poast \href{https://drive.google.com/file/d/1DhvgzRKwRumI_VWNEH34b-SFKwzfdm95/view?usp=sharing}{"Not a World War but a World at War"}

\item Day 3: TD3 Presentations
...
> You'll have three short essays to complete in this course. These will come at the end of each of our three units and should be anywhere from 700 to 1,200 words. You'll be asked to take a stance on an issue or debate related to our unit material and provide supporting evidence or claims in suppport of your position. These will be worth 15% of your grade each and combined make up 45\% of your final grade. Prompts will be posted to Canvas.
