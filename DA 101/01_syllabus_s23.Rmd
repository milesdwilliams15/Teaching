...
*Note:* All readings for discussion and other course materials will be available on Canvas. In-class exercises will involve real-time feedback using [this form](https://forms.gle/4FSEF6RrhVwyovf1A). "R4DS" = our primary textbook, [*R for Data Science*](https://r4ds.had.co.nz/).
