Hypothsis and significance testing
================
...
If the p-value is less than a pre-specified value alpha (usually we set
...
6.  p=0.05 means that we have observed data that would only occur 5% of
