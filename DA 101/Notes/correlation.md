...
In the above, we can visually see that `hh_income` and `per_dem_2016`
...
This is an example of selecting on the DV. You look only at a case or
...
<img src="correlation_files/figure-gfm/unnamed-chunk-8-1.png" width="75%" />
