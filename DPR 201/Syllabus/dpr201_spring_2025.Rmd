...
-   Wednesday: Syllabus + Software

# Part I: Description - U.S. Aid and Human Rights

## `r advdate(mon, 2)`

-   Monday: Looking at Data

-   Wednesday: Discussion 

## `r advdate(mon, 3)`

-   Monday: Modeling Data with Linear Regression

-   Wednesday: Discussion \hfill \textit{AC1 due}

## `r advdate(mon, 4)`: 

-   Monday: Quantifying the Role of Chance

-   Wednesday: Discussion \hfill \textit{AC2 due}
...
[Data and Research Design for Social Impact]()
