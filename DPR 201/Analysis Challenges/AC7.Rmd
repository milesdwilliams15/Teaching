...
I've made the data from Bertoli's study available. The code to read it into R is below. The dataset is fairly self-explanatory, but just to get you started, some key colums in the data are:
