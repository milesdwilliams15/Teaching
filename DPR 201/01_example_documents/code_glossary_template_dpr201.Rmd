---
title: "Code Glossary for DPR 201"
author: "[Name Goes Here]"
date: "`r Sys.Date()`"
output: html_document
---
   
## Data and Research Design Notes

This is a starter RMarkdown template for a code glossary. You can use it to take notes, write your code, and produce a good-looking, reproducible document that records the work you have done. At the very top of the file is a section of *metadata*, or information about what the file is and what it does. The metadata is delimited by three dashes at the start and another three at the end. You should change the author to your name. Keep the `output` line as it is for now, however. Each line in the metadata has a structure. First the *key* ("title", "author", etc), then a colon, and then the *value* associated with the key.  
...
The remainder of this document contains different section headings for the class and an empty code chunk in each section to get you started. Try knitting this document now by clicking the "Knit" button in the RStudio toolbar, or choosing File > Knit Document from the RStudio menu.
