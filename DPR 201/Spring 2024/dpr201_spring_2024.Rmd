...
-   Day 2: Read BDMF Ch1 "Thinking Clearly in a Data-Driven Age" + Getting our tech up and running. Reading on Canvas.
...
-   Day 2: MA1 Workshop. \hfill \textit{MA1 due Fri.}
...
> This is a low stakes assignment that will be assigned on a rotating basis. Each week on Wednesday we will read some study or article relevant to the material we'll cover that week. In a given week \~3 of you will turn in on Canvas a short set of responses to five questions about the assigned reading. These are:
